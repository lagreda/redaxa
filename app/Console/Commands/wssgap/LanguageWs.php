...
class LanguageWs extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'wssgap:language';
     ...
     * @var string
     */
    protected $description = 'Integration with SGAP web service: languages';
    ...
    public function handle()
    {
        ...
        $response = $client->request('GET', 'Idiomas', [
