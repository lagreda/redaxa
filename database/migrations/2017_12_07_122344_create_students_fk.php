...
class CreateStudentsFk extends Migration
{
    ...
    public function up()
    {
        Schema::table('students', function (Blueprint $table) {
            ...
            $table->integer('country_id_birth')->nullable()->unsigned();
            $table->foreign('country_id_birth')->references('id')->on('countries');
            $table->integer('country_id_residence')->nullable()->unsigned();
            $table->foreign('country_id_residence')->references('id')->on('countries');
            $table->integer('ec_city_id_birth')->nullable()->unsigned()->nullable();
            $table->foreign('ec_city_id_birth')->references('id')->on('ec_cities');
            $table->integer('ec_city_id_residence')->nullable()->unsigned()->nullable();
