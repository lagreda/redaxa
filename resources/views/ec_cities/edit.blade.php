        ...
        <div class="row">
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    @endif
                    <form action="{{ URL::to('ec-city/'.$city->id) }}" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="name" name="name" value="{{ $city->name }}" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>   
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">                          
                          <select name="ec_province_id" required="required" class="form-control col-md-7 col-xs-12">
                            ...
                            @foreach($provinces as $province)
                                ...
                                @if($city->ec_province_id == $province->id) selected @endif
